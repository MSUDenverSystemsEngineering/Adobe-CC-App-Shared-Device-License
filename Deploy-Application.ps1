...
Try {
	...
	[string]$appName = 'CC App (Shared Device)'
	[string]$appVersion = ''
	[string]$appArch = 'x64'
	[string]$appLang = 'EN'
...
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQUlYMrFb2/pxwKnGm9yODnslGh
# MoqggguhMIIFrjCCBJagAwIBAgIQBwNx0Q95WkBxmSuUB2Kb4jANBgkqhkiG9w0B
...
# gjcCAQsxDjAMBgorBgEEAYI3AgEVMCMGCSqGSIb3DQEJBDEWBBRb4WZqTue57BL+
# 2sb5MwceHWYtwTANBgkqhkiG9w0BAQEFAASCAQCOJY+HZBIOk4I2OFxj1LkGN5QH
# uwiNU/aEEBDLDvH7j+7nfoDAZI7SPpE4+njC9GU4nveUBKhk+zD24lcWgeoRLxl6
# HNTQr//w91GU1ER5aWpl0v8fcoYueJ3z7XypUKv3m3DxkGSi4/UVcOBmOs/RVV/7
# p58/Gi5QJ6Q2wLUwGKYwKPlohulxkS4WTD57l9t05+ql28ZIx3qeZ+U+b5tUuqcd
# zChbBLPvn/BFS/twQLsLSMDsqEWTCCqsFwgrJqci1hdCOd4qW+5E5NiqUbRR6/fw
# IOTe0On7J4UsWmhfPteKVAhRVxgNJkboke0lBR55FtNTA5Sz59bj666Pv//D
